...
vtkStandardNewMacro(vtkCustomPropPicker);
vtkCustomPropPicker::vtkCustomPropPicker()
{
...
// set up for a pick
void vtkCustomPropPicker::Initialize()
{
this->vtkAbstractPropPicker::Initialize();
}
// Pick from the given collection
int vtkCustomPropPicker::Pick(double selectionX, double selectionY,
...
// Pick from the given collection
int vtkCustomPropPicker::PickProp(double selectionX, double selectionY,
...
// Pick from the given collection
int vtkCustomPropPicker::Pick3DPoint(double pos[3], vtkRenderer *renderer)
{
if ( this->PickFromList )
{
...
// Pick from the given collection
int vtkCustomPropPicker::PickProp3DPoint(
double pos[3],
vtkRenderer *renderer, vtkPropCollection* pickfrom)
{
this->PickFromProps = pickfrom;
...
// Perform pick operation with selection point provided. The z location
// is recovered from the zBuffer. Always returns 0 since no actors are picked.
int vtkCustomPropPicker::PickProp3DPoint(double pos[3], vtkRenderer *renderer)
{
// Initialize picking process
this->Initialize();
this->Renderer = renderer;
...
void vtkCustomPropPicker::PrintSelf(ostream& os, vtkIndent indent)
{
